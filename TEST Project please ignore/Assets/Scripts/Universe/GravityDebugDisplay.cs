...
{
    [ExecuteInEditMode]
    public class GravityDebugDisplay : MonoBehaviour
    {
        ...
        void DrawOrbits()
        {
            ...
            {
                var pathColour = bodies[bodyIndex].trailColor; //
        ...
        Vector3 CalculateAcceleration(int i, VirtualBody[] virtualBodies)
        {
            ...
            for (int j = 0; j < virtualBodies.Length; j++)
            {
                ...
                acceleration += forceDir * UniverseConstants.G * virtualBodies[j].mass / sqrDst;
            }
            return acceleration;
        }
